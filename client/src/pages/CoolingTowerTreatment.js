    ...
    <div className="pt-24 px-4">
      <div className="p-8 max-w-5xl mx-auto">
        <p className="text-lg text-center max-w-3xl mx-auto mb-8">
          Forget scale, bio‑film and Legionella worries. Our chemical‑lean cavitation approach keeps your
          cooling circuits pristine, extends equipment life and boosts energy efficiency.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-4 mb-16">
        {[
          {
            type: 'image',
            title: 'Scale‑Free Heat Exchangers',
            image: '/cooling_treatment.jpg',
            text: 'Inline cavitation inhibits calcium carbonate deposition even at high COC.'
          },
          {
            type: 'image',
            title: 'Bio‑film Control',
            image: '/biofilm.png',
            text: 'Shear forces rupture microbial colonies, slashing biocide consumption by > 60 %.'
          },
          {
            type: 'image',
            title: 'Energy Savings',
            image: '/savings.jpg',
            text: 'Clean surfaces translate to lower approach temperatures and 5‑8 % chiller power savings.'
          }
        ].map((card, i) => (
          <div
            key={i}
...
export default CoolingTowerTreatment;
